        ...
        <>
            <div className="page-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                    <button className="btn btn-ghost btn-icon" onClick={() => navigate('/app/payables')}>
                        <ArrowLeft size={18} />
                    </button>
                    <div>
                        <h2 className="page-title">{isEdit ? 'Editar Conta a Pagar' : 'Nova Conta a Pagar'}</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-actions">
                                <button type="button" className="btn btn-secondary" onClick={() => navigate('/app/payables')}>
                                    Cancelar
                                </button>
