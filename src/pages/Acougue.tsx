...
export function Acougue() {
    return (
        <CompanyPage
            ...
            about="O Vale do Boi Carnes é o ponto de venda direto ao consumidor do nosso grupo. Aqui você encontra os melhores cortes bovinos, selecionados diariamente com frescor e qualidade garantidos. Nossos açougueiros são profissionais experientes que preparam cada corte com cuidado e atenção para oferecer a melhor experiência ao cliente."
            services={[
                {
                    icon: <Beef size={24} />,
